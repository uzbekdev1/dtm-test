...
namespace OmrMarkEngine.Template
{
    ...
    public abstract class OmrQuestionField : OmrBoundObject
    {
        ...
        {
            get { return m_answerRowGroup; }
            set
            {
                m_answerRowGroup = value;
                OnPropertyChange("AnswerRowGroup");
            }
        }
        ...
        {
            get { return m_isQuestionRequired; }
            set
            {
                m_isQuestionRequired = value;
                OnPropertyChange("IsQuestionRequired");
            }
        }
